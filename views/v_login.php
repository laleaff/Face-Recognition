                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Sistem Informasi<br />Presensi Siswa</h1>
                                    </div>
                                    <form class="user" method="POST" action="<?php echo base_url(); ?>login/do_login">
                                        ...
                                        <button class="btn btn-primary btn-user btn-block" style="background: #283342; border: 1px solid #283342;">
                                            Masuk
                                        </button>
                                    </form>
                                </div>
