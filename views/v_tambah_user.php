                ...
                <div class="card-body">
                    <form method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input <?php if (!$fetch['password']) {
                                            echo "required";
                                        } ?> type="password" name="password" class="form-control" id="" <?php if ($fetch['password']) { ?>placeholder="Kosongkan Apabila Tidak Dirubah" <?php } ?> value="">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="" class="col-sm-2 col-form-label">Role</label>
                            <div class="col-sm-10">
                                <select required class="form-control" name="role" id="role" onchange="changeRole()">
                                    <option value="">Pilih Role</option>
                                    <option <?php if ($fetch['role'] == 'pegawai') {
                        ...
                        <div class="form-group row rolePegawai" <?php if ($fetch['role'] == 'admin') { ?>style="display: none;" <?php } ?>>
                            <label for="" class="col-sm-2 col-form-label">Pegawai</label>
                            <div class="col-sm-10">
                                <select class="form-control" name="id_pegawai">
                                    <option value="">Pilih Data Pegawai</option>
                                    <?php if ($fetch['password']) {
                                        $pegawai = $pegawai2;
                                    }
