...
<script>
    try {
        ...
        <?php
        $mps = $confusion_matrix['Positif']['Positif'] + $confusion_matrix['Negatif']['Positif'];
        $mns = $confusion_matrix['Positif']['Negatif'] + $confusion_matrix['Negatif']['Negatif'];
        $kps = $confusion_matrix['Positif']['Positif'] + $confusion_matrix['Positif']['Negatif'];
        $kns = $confusion_matrix['Negatif']['Negatif'] + $confusion_matrix['Negatif']['Positif'];
        $_acc = (int) ($confusion_matrix['Positif']['Positif'] + $confusion_matrix['Negatif']['Negatif'] / ($mps + $mns));
